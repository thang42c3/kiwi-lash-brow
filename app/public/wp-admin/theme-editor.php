...
foreach ( $file_types as $type ) {
	switch ( $type ) {
		...
		case 'css':
			...
			$allowed_files['style-index.css'] = $style_files['style-index.css'];
...
// Move functions.php and style-index.css to the top.
if ( isset( $allowed_files['functions.php'] ) ) {
	$allowed_files = array( 'functions.php' => $allowed_files['functions.php'] ) + $allowed_files;
}
if ( isset( $allowed_files['style-index.css'] ) ) {
	$allowed_files = array( 'style-index.css' => $allowed_files['style-index.css'] ) + $allowed_files;
}

if ( empty( $file ) ) {
	$relative_file = 'style-index.css';
	$file          = $allowed_files['style-index.css'];
} else {
