...
class Theme_Upgrader extends WP_Upgrader {
	...
	public function check_package( $source ) {
		...
		// A proper archive should have a style-index.css file in the single subdirectory.
		if ( ! file_exists( $working_directory . 'style-index.css' ) ) {
			return new WP_Error(
				'incompatible_archive_theme_no_style',
				$this->strings['incompatible_archive'],
				sprintf(
					/* translators: %s: style-index.css */
		...
		$info = get_file_data(
			$working_directory . 'style-index.css',
			array(
				'Name'        => 'Theme Name',
				'Version'     => 'Version',
				'Author'      => 'Author',
