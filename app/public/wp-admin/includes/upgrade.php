...
function make_site_theme_from_oldschool( $theme_name, $template ) {
	...
	$stylelines = file_get_contents( "$site_dir/style-index.css" );
	if ( $stylelines ) {
		$f = fopen( "$site_dir/style-index.css", 'w' );
...
function make_site_theme_from_default( $theme_name, $template ) {
	...
	// $files = array( 'index.php', 'comments.php', 'comments-popup.php', 'footer.php', 'header.php', 'sidebar.php', 'style-index.css' );
	...
	$stylelines = explode( "\n", implode( '', file( "$site_dir/style-index.css" ) ) );
	if ( $stylelines ) {
		$f = fopen( "$site_dir/style-index.css", 'w' );
