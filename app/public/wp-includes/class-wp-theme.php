...
final class WP_Theme implements ArrayAccess {
	...
	/**
	 * Headers for style-index.css files.
	 *
	 * @since 3.4.0
	...
	/**
	 * Header data from the theme's style-index.css file.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Header data from the theme's style-index.css file after being sanitized.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Header name from the theme's style-index.css after being translated.
	 *
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		$theme_file       = $this->stylesheet . '/style-index.css';
		...
		if ( ! $this->template ) {
			...
			if (
				...
				$error_message = sprintf(
					/* translators: 1: templates/index.html, 2: index.php, 3: Documentation URL, 4: Template, 5: style-index.css */
					__( 'Template is missing. Standalone themes need to have a %1$s or %2$s template file. <a href="%3$s">Child themes</a> need to have a %4$s header in the %5$s stylesheet.' ),
					'<code>templates/index.html</code>',
					'<code>index.php</code>',
					__( 'https://developer.wordpress.org/themes/advanced-topics/child-themes/' ),
					'<code>Template</code>',
					'<code>style-index.css</code>'
				);
	 ...
	 * The 'Template' header is only good for what was written in the style-index.css, while
