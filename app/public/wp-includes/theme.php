 ...
 *
 * The stylesheet file name is 'style-index.css' which is appended to the stylesheet directory URI path.
...
function get_stylesheet_uri() {
	...
	$stylesheet_uri     = $stylesheet_dir_uri . '/style-index.css';
	/**
...
function search_theme_directories( $force = false ) {
		...
		if ( is_array( $cached_roots ) ) {
			foreach ( $cached_roots as $theme_dir => $theme_root ) {
				...
				$found_themes[ $theme_dir ] = array(
					'theme_file' => $theme_dir . '/style-index.css',
	...
	foreach ( $wp_theme_directories as $theme_root ) {
		...
		foreach ( $dirs as $dir ) {
			...
			if ( file_exists( $theme_root . '/' . $dir . '/style-index.css' ) ) {
				// wp-content/themes/a-single-theme
				// wp-content/themes is $theme_root, a-single-theme is $dir.
				$found_themes[ $dir ] = array(
					'theme_file' => $dir . '/style-index.css',
				...
				foreach ( $sub_dirs as $sub_dir ) {
					...
					if ( ! file_exists( $theme_root . '/' . $dir . '/' . $sub_dir . '/style-index.css' ) ) {
						continue;
					}
					$found_themes[ $dir . '/' . $sub_dir ] = array(
						'theme_file' => $dir . '/' . $sub_dir . '/style-index.css',
						'theme_root' => $theme_root,
					);
					$found_theme                           = true;
				}
				// Never mind the above, it's just a theme missing a style-index.css.
 ...
 * Child themes need to have a `Template` header in the `style-index.css` stylesheet.
 *
...
function validate_current_theme() {
	...
	if (
		...
		// Invalid.
	} elseif ( ! file_exists( get_template_directory() . '/style-index.css' ) ) {
		// Invalid.
	} elseif ( is_child_theme() && ! file_exists( get_stylesheet_directory() . '/style-index.css' ) ) {
		// Invalid.
	} else {
		// Valid.
		return true;
 ...
 * defined in the theme's `style-index.css` file.
 *
 * @since 5.5.0
...
function _custom_background_cb() {
	...
	// A default has to be specified in style-index.css. It will not be printed here.
 ...
 * It is optional and defaults to 'editor-style-index.css'.
 *
 ...
 *                                 Defaults to 'editor-style-index.css'
 */
function add_editor_style( $stylesheet = 'editor-style-index.css' ) {
